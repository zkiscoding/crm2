	...
	$(function(){
		...
		$("#convertBtn").click(function(){
			if($("#isCreateTransaction").prop("checked")){
				...
				// 不需要创建交易
				window.location.href = "workbench/clue/convert.do?clueId=${clue.id}&flag=0";
			}
		})
...
<%--							</tr>--%>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="open-btn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
	...
	<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input class="btn btn-default" type="button" value="取消" onclick="window.location.href='workbench/clue/index.jsp'">
	</div>
</body>
</html>