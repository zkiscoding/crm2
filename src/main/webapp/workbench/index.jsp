					...
					<form class="form-horizontal" role="form" id="editForm">
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" name="password" class="form-control" id="oldPwd" style="width: 200%;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" name="newPassword" class="form-control" id="newPwd" style="width: 200%;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" name="checkPassword" class="form-control" id="confirmPwd" style="width: 200%;">
							</div>
						</div>
					</form>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal" onclick="resetPwd()">取消</button>
					<button type="button" class="btn btn-primary" id="updatePassword">更新</button>
				</div>
			</div>
		</div>
	</div>
