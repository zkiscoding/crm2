		...
		$(function (){
			$("#saveBtn").click(function (){
				if($("#code").val()==''||$("#name").val()==''){
					...
					url:"settings/user/saveDicType.do",
					data:{
						"code":$("#code").val(),
						"name":$("#name").val(),
					...
					success:function (data){
						if(data.success){
							document.location.href='settings/dictionary/index.jsp'
						}else {
							alert(data.msg)
						}
					}
	...
	<form class="form-horizontal" role="form">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="code" style="width: 200%;" placeholder="编码作为主键">
			</div>
		</div>
