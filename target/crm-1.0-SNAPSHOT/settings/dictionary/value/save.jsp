...
<script type="text/javascript" src="jquery/bootstrap_3.3.0/js/bootstrap.min.js"></script>
	<script>
			...
			$("#saveBtn").click(function (){
				$.ajax({
					...
					success:function (data){
						if(data){
							document.location.href='settings/dictionary/value/index.jsp'
						}else {
							alert("保存失败")
						}
					}
		...
		function ShowdicTypeCode(){
			$.ajax({
				url:"settings/dictionary/value/getDicCode.do",
				type:"get",
				dataType:"json",
				success:function (data){
					var html="";
					$.each(data,function (i,n){
						html += "<option id='"+n.code+"'>"+n.code+"</option>"
					})
