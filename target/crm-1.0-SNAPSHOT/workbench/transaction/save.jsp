...
<body>
	...
	<form class="form-horizontal" id="TranForm" action="workbench/transaction/saveTran.do" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" id="hidden-activitySrc" name="activityId" value="d592b01c019d4be28c3e4b810b69c7f0">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" value="孔某某" id="create-contactsName">
				<input type="hidden" name="contactsId" value="6e8ce299fd124aaaa5e8f80ab2cdf193"  id="hidden-contactsName">
			</div>
		</div>
